...
class Api:
    ...
    def mediatypes_method(self): # -> (resource_cls: Unknown) -> list[str]:
    ...
    def resource(self, *urls, **kwargs): # -> (cls: Unknown) -> Unknown:
    ...
    def output(self, resource): # -> _Wrapped[(...), Unknown, (*args: Unknown, **kwargs: Unknown), werkzeug.wrappers.response.Response | Unknown | flask.wrappers.Response]:
    ...
    def representation(self, mediatype): # -> (func: Unknown) -> Unknown:
...
def marshal(data, fields, envelope=...): # -> list[Unknown]:
...
class marshal_with:
    ...
    def __call__(self, f): # -> _Wrapped[(...), Unknown, (*args: Unknown, **kwargs: Unknown), tuple[Unknown | list[Unknown], Unknown | Literal[200], Unknown | dict[Unknown, Unknown]] | Unknown | list[Unknown]]:
        ...
...
class marshal_with_field:
    ...
    def __call__(self, f): # -> _Wrapped[(...), Unknown, (*args: Unknown, **kwargs: Unknown), tuple[Any | Unknown, Unknown | Literal[200], Unknown | dict[Unknown, Unknown]] | Any | Unknown]:
        ...
