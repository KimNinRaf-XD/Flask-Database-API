...
def to_marshallable_type(obj): # -> dict[Unknown, Unknown] | None:
...
class Nested(Raw):
    ...
    def output(self, key, obj): # -> list[Unknown] | None:
        ...
...
class List(Raw):
    ...
    def format(self, value): # -> list[Unknown | Any | None]:
        ...
    
    def output(self, key, data): # -> list[Unknown | Any | None] | list[Unknown | list[Unknown]] | None:
        ...
...
class String(Raw):
    ...
    python3.
    """
    def format(self, value): # -> text_type:
        ...
