...
class Argument:
    ...
    def source(self, request): # -> Any | dict[Any, Any] | MultiDict[Unknown, Unknown]:
        """Pulls values off the request in the provided location
        :param request: The flask request object to parse arguments from
        """
        ...
    
    def convert(self, value, op): # -> FileStorage | text_type | None:
        ...
    
    def handle_validation_error(self, error, bundle_errors): # -> tuple[Unknown, dict[Unknown, Unknown | text_type]] | None:
...
class RequestParser:
    ...
    def add_argument(self, *args, **kwargs): # -> Self@RequestParser:
    ...
    def copy(self): # -> RequestParser:
        """ Creates a copy of this RequestParser with the same set of arguments """
        ...
    
    def replace_argument(self, name, *args, **kwargs): # -> Self@RequestParser:
        """ Replace the argument matching the given name with a new version. """
        ...
    
    def remove_argument(self, name): # -> Self@RequestParser:
